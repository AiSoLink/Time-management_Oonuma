...
class App(tk.Tk):
    def __init__(self):
        ...
        left_m.grid_rowconfigure(1, weight=1)
        left_m.grid_rowconfigure(3, weight=1)
        left_m.grid_columnconfigure(0, weight=1)

        tk.Label(left_m, text="毎日ファイル").grid(row=0, column=0, sticky="w")
        ...
        tk.Label(left_m, text="作業明細").grid(row=2, column=0, sticky="w", pady=(10, 0))
        work_frame = tk.Frame(left_m)
        work_frame.grid(row=3, column=0, sticky="nsew")
